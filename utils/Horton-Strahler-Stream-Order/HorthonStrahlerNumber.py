...
from utils import ReadTree, StrahlerOrder, TreeStatistics, PlotTreeStatistics
...
outputImageFile = 'img/' + Path(ccoFile).stem + '.png'
PlotTreeStatistics(orderedTree, outputImageFile=outputImageFile)
