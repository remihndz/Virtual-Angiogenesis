...
string outputFileName = "../Results/Retina",
    ...
    double theta_min)
{
    ...
    double q0 {0.035};		// cm3/s
    double r0 {0.0198};		// cm
    point x0 {0.0, 0.0, -1.0};	// cm
    
    // Number of terminals to be generated
    long long int n_term_0 {30}, n_term_1 {500};
    // Domain geometry
    ...
    GeneratorData *gen_data_1 = new GeneratorData(16000, N_fail, l_lim_fr, perfusion_area_factor, close_neighborhood_factor, 0.25, Delta_nu, 0, false);
    ...
    SingleVesselCCOOTree *tree = new SingleVesselCCOOTree(x0, r0, q0, gam, delta, eta, 16, 1.0e-5,
							  gen_data_0);    
...
int main(int argc, char *argv[])
{
    ...
    double theta_min {20.0*M_PI/180}; // {(3./18.) * M_PI};
